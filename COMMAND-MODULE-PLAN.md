...
per-occupancy benchmarks), Phase 5 (deployment-model suggestions), Phase 6 (plain-text
export), and Phase 7 (undo, save/load hardening, FAQ) built and verified in-browser
Aug 5 2026. All six source documents in `Command Reference/` have now been read in full,
including the Commercial/Big-Box and High Rise bulletins. Only Phase 8 (the real-world
drill) remains before this can merge to `main`.
